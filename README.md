...
**🎯 Goal** <br>
The goal of this repository is to demonstrate practical database design skills, relational modeling, and the use of SQL for managing and analyzing structured data.
